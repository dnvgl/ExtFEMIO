/**
   \file test_fem_element_ftrs_fftr.cpp
   \author Berthold Höllmann <berthold.hoellmann@dnvgl.com>
   \copyright Copyright © 2016 by DNV GL SE
   \brief Tests for reading and writing FEM FTRS_FFTR element information.
...
TEST_CASE("FEM FTRS_FFTR element definitions.", "[fem_element_ftrs_fftr]") {
   ...
   SECTION("check members") {
      ...
      CHECK(probe.processors == std::set<el_processor> ({
               ADVANCE, Prefem, Poseidon, general, Sestra, Platework }));
