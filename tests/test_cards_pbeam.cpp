...
// Purpose: Testing the BDF PBEAM card class.
...
//     1234567A1234567B1234567C1234567D1234567E1234567F1234567G1234567H1234567I
  ...
  SECTION("Free Field Format 2") {
    ...
    CHECK(*probe.S1 == 51);
    CHECK(*probe.S2 == 52);
    CHECK(*probe.NSI_A == 53);
    CHECK(*probe.NSI_B == 54);
    CHECK(*probe.CW_A == 55);
    CHECK(*probe.CW_B == 56);
    CHECK(*probe.M1_A == 57);
    CHECK(*probe.M2_A == 58);
