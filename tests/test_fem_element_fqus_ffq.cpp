/**
   \file test_fem_element_fqus_ffq.cpp
   \author Berthold Höllmann <berthold.hoellmann@dnvgl.com>
   \copyright Copyright © 2016 by DNV GL SE
   \brief Tests for reading and writing FEM FQUS_FFQ element information.
...
TEST_CASE("FEM FQUS_FFQ element definitions.", "[fem_element_fqus_ffq]") {
   ...
   SECTION("check members") {
      ...
      CHECK(probe.processors == std::set<el_processor> ({
               ADVANCE, Prefem, Pretube, Poseidon, general, Sestra, Platework }));
