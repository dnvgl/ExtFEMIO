/**
   \file fem/fem_element_ghex137.cpp
...
el_types ghex137::get_type() const {return GHEX137;}
...
ghex137::ghex137(const ::dnvgl::extfem::fem::cards::gelmnt1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex137::ghex137(const ::dnvgl::extfem::fem::cards::gelref1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex137::ghex137(const __base *data) :
   ghex(data) {}

el_types ghex137::get_type(void) const {
   return GHEX137;
}
