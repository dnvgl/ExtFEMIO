/**
   \file fem/fem_element_ghex146.cpp
...
el_types ghex146::get_type() const {return GHEX146;}
...
ghex146::ghex146(const ::dnvgl::extfem::fem::cards::gelmnt1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex146::ghex146(const ::dnvgl::extfem::fem::cards::gelref1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex146::ghex146(const __base *data) :
   ghex(data) {}

el_types ghex146::get_type(void) const {
   return GHEX146;
}
