   ...
   namespace extfem {
      namespace fem {
         namespace elements {
            ...
            void dispatch(
               std::unique_ptr<__base::elem> &res, const gelmnt1 *data) {
            ...
            namespace __base {
               ...
               elem::elem(dnvgl::extfem::fem::cards::gelref1 const *data) :
               ...
               void elem::add(dnvgl::extfem::fem::cards::gelmnt1 const *data) {
               ...
               void elem::add(dnvgl::extfem::fem::cards::gelref1 const *data) {
                  this->elident = data->ELNO;
            ...
            undef::undef(const gelref1 *data) :
               __base::elem(data) {}
         }
      }
   }
