/**
   \file fem/fem_element_ghex151.cpp
...
el_types ghex151::get_type() const {return GHEX151;}
...
ghex151::ghex151(const ::dnvgl::extfem::fem::cards::gelmnt1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex151::ghex151(const ::dnvgl::extfem::fem::cards::gelref1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex151::ghex151(const __base *data) :
   ghex(data) {}

el_types ghex151::get_type(void) const {
   return GHEX151;
}
