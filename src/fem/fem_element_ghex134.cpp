/**
   \file fem/fem_element_ghex134.cpp
...
el_types ghex134::get_type() const {return GHEX134;}
...
ghex134::ghex134(const ::dnvgl::extfem::fem::cards::gelmnt1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex134::ghex134(const ::dnvgl::extfem::fem::cards::gelref1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex134::ghex134(const __base *data) :
   ghex(data) {}

el_types ghex134::get_type(void) const {
   return GHEX134;
}
