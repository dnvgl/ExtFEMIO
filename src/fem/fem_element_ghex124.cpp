/**
   \file fem/fem_element_ghex124.cpp
...
el_types ghex124::get_type() const {return GHEX124;}
...
ghex124::ghex124(const ::dnvgl::extfem::fem::cards::gelmnt1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex124::ghex124(const ::dnvgl::extfem::fem::cards::gelref1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex124::ghex124(const __base *data) :
   ghex(data) {}

el_types ghex124::get_type(void) const {
   return GHEX124;
}
