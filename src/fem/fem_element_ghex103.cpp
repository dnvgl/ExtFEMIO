/**
   \file fem/fem_element_ghex103.cpp
...
el_types ghex103::get_type() const {return GHEX103;}
...
ghex103::ghex103(const ::dnvgl::extfem::fem::cards::gelmnt1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex103::ghex103(const ::dnvgl::extfem::fem::cards::gelref1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex103::ghex103(const __base *data) :
   ghex(data) {}

el_types ghex103::get_type(void) const {
   return GHEX103;
}
