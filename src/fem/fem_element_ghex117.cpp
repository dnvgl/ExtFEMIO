...
el_types ghex117::get_type() const {return GHEX117;}
...
ghex117::ghex117(const ::dnvgl::extfem::fem::cards::gelmnt1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex117::ghex117(const ::dnvgl::extfem::fem::cards::gelref1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex117::ghex117(const __base *data) :
   ghex(data) {}

el_types ghex117::get_type(void) const {
   return GHEX117;
}
