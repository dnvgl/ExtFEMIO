/**
   \file fem/fem_element_ghex121.cpp
...
el_types ghex121::get_type() const {return GHEX121;}
...
ghex121::ghex121(const ::dnvgl::extfem::fem::cards::gelmnt1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex121::ghex121(const ::dnvgl::extfem::fem::cards::gelref1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex121::ghex121(const __base *data) :
   ghex(data) {}

el_types ghex121::get_type(void) const {
   return GHEX121;
}
