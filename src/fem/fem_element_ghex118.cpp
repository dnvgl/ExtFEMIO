/**
   \file fem/fem_element_ghex118.cpp
...
el_types ghex118::get_type() const {return GHEX118;}
...
ghex118::ghex118(const ::dnvgl::extfem::fem::cards::gelmnt1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex118::ghex118(const ::dnvgl::extfem::fem::cards::gelref1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex118::ghex118(const __base *data) :
   ghex(data) {}

el_types ghex118::get_type(void) const {
   return GHEX118;
}
