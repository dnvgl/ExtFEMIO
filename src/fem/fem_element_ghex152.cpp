/**
   \file fem/fem_element_ghex152.cpp
...
el_types ghex152::get_type() const {return GHEX152;}
...
ghex152::ghex152(const ::dnvgl::extfem::fem::cards::gelmnt1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex152::ghex152(const ::dnvgl::extfem::fem::cards::gelref1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex152::ghex152(const __base *data) :
   ghex(data) {}

el_types ghex152::get_type(void) const {
   return GHEX152;
}
