/**
   \file fem/fem_element_ghex159.cpp
...
el_types ghex159::get_type() const {return GHEX159;}
...
ghex159::ghex159(const ::dnvgl::extfem::fem::cards::gelmnt1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex159::ghex159(const ::dnvgl::extfem::fem::cards::gelref1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex159::ghex159(const __base *data) :
   ghex(data) {}

el_types ghex159::get_type(void) const {
   return GHEX159;
}
