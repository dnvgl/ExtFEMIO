/**
   \file fem/fem_element_ghex106.cpp
...
el_types ghex106::get_type() const {return GHEX106;}
...
ghex106::ghex106(const ::dnvgl::extfem::fem::cards::gelmnt1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex106::ghex106(const ::dnvgl::extfem::fem::cards::gelref1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex106::ghex106(const __base *data) :
   ghex(data) {}

el_types ghex106::get_type(void) const {
   return GHEX106;
}
