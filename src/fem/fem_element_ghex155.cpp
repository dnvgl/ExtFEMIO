/**
   \file fem/fem_element_ghex155.cpp
...
el_types ghex155::get_type() const {return GHEX155;}
...
ghex155::ghex155(const ::dnvgl::extfem::fem::cards::gelmnt1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex155::ghex155(const ::dnvgl::extfem::fem::cards::gelref1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex155::ghex155(const __base *data) :
   ghex(data) {}

el_types ghex155::get_type(void) const {
   return GHEX155;
}
