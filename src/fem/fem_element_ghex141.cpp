/**
   \file fem/fem_element_ghex141.cpp
...
el_types ghex141::get_type() const {return GHEX141;}
...
ghex141::ghex141(const ::dnvgl::extfem::fem::cards::gelmnt1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex141::ghex141(const ::dnvgl::extfem::fem::cards::gelref1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex141::ghex141(const __base *data) :
   ghex(data) {}

el_types ghex141::get_type(void) const {
   return GHEX141;
}
