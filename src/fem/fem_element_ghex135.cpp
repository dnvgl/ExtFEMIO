/**
   \file fem/fem_element_ghex135.cpp
...
el_types ghex135::get_type() const {return GHEX135;}
...
ghex135::ghex135(const ::dnvgl::extfem::fem::cards::gelmnt1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex135::ghex135(const ::dnvgl::extfem::fem::cards::gelref1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex135::ghex135(const __base *data) :
   ghex(data) {}

el_types ghex135::get_type(void) const {
   return GHEX135;
}
