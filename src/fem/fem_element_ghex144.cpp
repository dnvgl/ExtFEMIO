/**
   \file fem/fem_element_ghex144.cpp
...
el_types ghex144::get_type() const {return GHEX144;}
...
ghex144::ghex144(const ::dnvgl::extfem::fem::cards::gelmnt1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex144::ghex144(const ::dnvgl::extfem::fem::cards::gelref1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex144::ghex144(const __base *data) :
   ghex(data) {}

el_types ghex144::get_type(void) const {
   return GHEX144;
}
