/**
   \file fem/fem_element_ghex156.cpp
...
el_types ghex156::get_type() const {return GHEX156;}
...
ghex156::ghex156(const ::dnvgl::extfem::fem::cards::gelmnt1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex156::ghex156(const ::dnvgl::extfem::fem::cards::gelref1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex156::ghex156(const __base *data) :
   ghex(data) {}

el_types ghex156::get_type(void) const {
   return GHEX156;
}
