/**
   \file fem/fem_element_ghex102.cpp
...
el_types ghex102::get_type() const {return GHEX102;}
...
ghex102::ghex102(const ::dnvgl::extfem::fem::cards::gelmnt1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex102::ghex102(const ::dnvgl::extfem::fem::cards::gelref1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex102::ghex102(const __base *data) :
   ghex(data) {}

el_types ghex102::get_type(void) const {
   return GHEX102;
}
