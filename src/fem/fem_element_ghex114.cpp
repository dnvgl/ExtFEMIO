/**
   \file fem/fem_element_ghex114.cpp
...
el_types ghex114::get_type() const {return GHEX114;}
...
ghex114::ghex114(const ::dnvgl::extfem::fem::cards::gelmnt1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex114::ghex114(const ::dnvgl::extfem::fem::cards::gelref1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex114::ghex114(const __base *data) :
   ghex(data) {}

el_types ghex114::get_type(void) const {
   return GHEX114;
}
