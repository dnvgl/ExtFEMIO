/**
   \file fem/fem_element_ghex139.cpp
...
el_types ghex139::get_type() const {return GHEX139;}
...
ghex139::ghex139(const ::dnvgl::extfem::fem::cards::gelmnt1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex139::ghex139(const ::dnvgl::extfem::fem::cards::gelref1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex139::ghex139(const __base *data) :
   ghex(data) {}

el_types ghex139::get_type(void) const {
   return GHEX139;
}
