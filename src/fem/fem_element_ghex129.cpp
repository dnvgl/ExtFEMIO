/**
   \file fem/fem_element_ghex129.cpp
...
el_types ghex129::get_type() const {return GHEX129;}
...
ghex129::ghex129(const ::dnvgl::extfem::fem::cards::gelmnt1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex129::ghex129(const ::dnvgl::extfem::fem::cards::gelref1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex129::ghex129(const __base *data) :
   ghex(data) {}

el_types ghex129::get_type(void) const {
   return GHEX129;
}
