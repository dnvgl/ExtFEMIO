/**
   \file fem/fem_element_ghex125.cpp
...
el_types ghex125::get_type() const {return GHEX125;}
...
ghex125::ghex125(const ::dnvgl::extfem::fem::cards::gelmnt1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex125::ghex125(const ::dnvgl::extfem::fem::cards::gelref1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex125::ghex125(const __base *data) :
   ghex(data) {}

el_types ghex125::get_type(void) const {
   return GHEX125;
}
