/**
   \file fem/fem_element_ghex128.cpp
...
el_types ghex128::get_type() const {return GHEX128;}
...
ghex128::ghex128(const ::dnvgl::extfem::fem::cards::gelmnt1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex128::ghex128(const ::dnvgl::extfem::fem::cards::gelref1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex128::ghex128(const __base *data) :
   ghex(data) {}

el_types ghex128::get_type(void) const {
   return GHEX128;
}
