/**
   \file fem/fem_element_ghex160.cpp
...
el_types ghex160::get_type() const {return GHEX160;}
...
ghex160::ghex160(const ::dnvgl::extfem::fem::cards::gelmnt1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex160::ghex160(const ::dnvgl::extfem::fem::cards::gelref1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex160::ghex160(const __base *data) :
   ghex(data) {}

el_types ghex160::get_type(void) const {
   return GHEX160;
}
