/**
   \file fem/fem_element_ghex107.cpp
...
el_types ghex107::get_type() const {return GHEX107;}
...
ghex107::ghex107(const ::dnvgl::extfem::fem::cards::gelmnt1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex107::ghex107(const ::dnvgl::extfem::fem::cards::gelref1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex107::ghex107(const __base *data) :
   ghex(data) {}

el_types ghex107::get_type(void) const {
   return GHEX107;
}
