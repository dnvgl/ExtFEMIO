/**
   \file fem/fem_element_ghex154.cpp
...
el_types ghex154::get_type() const {return GHEX154;}
...
ghex154::ghex154(const ::dnvgl::extfem::fem::cards::gelmnt1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex154::ghex154(const ::dnvgl::extfem::fem::cards::gelref1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex154::ghex154(const __base *data) :
   ghex(data) {}

el_types ghex154::get_type(void) const {
   return GHEX154;
}
