/**
   \file fem/fem_element_ghex138.cpp
...
el_types ghex138::get_type() const {return GHEX138;}
...
ghex138::ghex138(const ::dnvgl::extfem::fem::cards::gelmnt1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex138::ghex138(const ::dnvgl::extfem::fem::cards::gelref1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex138::ghex138(const __base *data) :
   ghex(data) {}

el_types ghex138::get_type(void) const {
   return GHEX138;
}
