/**
   \file fem/fem_element_ghex157.cpp
...
el_types ghex157::get_type() const {return GHEX157;}
...
ghex157::ghex157(const ::dnvgl::extfem::fem::cards::gelmnt1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex157::ghex157(const ::dnvgl::extfem::fem::cards::gelref1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex157::ghex157(const __base *data) :
   ghex(data) {}

el_types ghex157::get_type(void) const {
   return GHEX157;
}
