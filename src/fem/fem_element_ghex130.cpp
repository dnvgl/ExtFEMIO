/**
   \file fem/fem_element_ghex130.cpp
...
el_types ghex130::get_type() const {return GHEX130;}
...
ghex130::ghex130(const ::dnvgl::extfem::fem::cards::gelmnt1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex130::ghex130(const ::dnvgl::extfem::fem::cards::gelref1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex130::ghex130(const __base *data) :
   ghex(data) {}

el_types ghex130::get_type(void) const {
   return GHEX130;
}
