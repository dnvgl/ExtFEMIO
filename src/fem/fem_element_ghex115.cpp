/**
   \file fem/fem_element_ghex115.cpp
...
el_types ghex115::get_type() const {return GHEX115;}
...
ghex115::ghex115(const ::dnvgl::extfem::fem::cards::gelmnt1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex115::ghex115(const ::dnvgl::extfem::fem::cards::gelref1 *data) :
   ::dnvgl::extfem::fem::elements::ghex(data) {}

ghex115::ghex115(const __base *data) :
   ghex(data) {}

el_types ghex115::get_type(void) const {
   return GHEX115;
}
